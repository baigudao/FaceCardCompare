...
import com.taisau.facecardcompare.util.DisplayUtil;
...
public class MySwipeRefreshLayout extends PtrFrameLayout {
    ...
    private int[] colors = new int[]{Color.parseColor("#6E9AC1"), Color.parseColor("#ff9900"),
            Color.parseColor("#009900"), Color.parseColor("#000099") };
    ...
    private void initConfig() {
        setOffsetToRefresh(DisplayUtil.dp2px(getContext(), 100));
        /**
         * 阻尼系数
         * 默认: 1.7f，越大，感觉下拉时越吃力
         */
