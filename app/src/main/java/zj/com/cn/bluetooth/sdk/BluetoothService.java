...
public class BluetoothService {
     ...
     * @param handler  A Handler to send messages back1 to the UI Activity
     */
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        // Send the name of the connected device back1 to the UI Activity
    ...
    private void connectionFailed() {
        ...
        // Send a failure message back1 to the Activity
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                // Share the sent message back1 to the UI Activity
